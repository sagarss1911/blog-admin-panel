...
export class CommonService {
  ...
  private getAllThicknessUrl =
    environment.url + '/api/common/get_all_thickness';
  ...
  private getAllWearLayerUrl =
    environment.url + '/api/common/get_all_wear_layer';
  ...
  private getAllProductListForSubProductUrl =
    environment.url + '/api/common/get_all_product_list_for_sub_product';
  private getAllProjectCategoryListUrl =
    environment.url + '/api/common/get_all_project_category_list';
  private getAllProjectListUrl =
    environment.url + '/api/common/get_all_project_list';
  ...
  private getAllProjectsUrl =
    environment.url + '/api/common/get_all_product_options';
  private deleteProjectsUrl =
  ...
  deleteProjects(id) {
    return this.http.delete(this.deleteProjectsUrl + id, {
      headers: this.getHeader(),
    });
  }
  ...
  getAllProjectList(data) {
    return this.http.post(this.getAllProjectListUrl, data, {
      headers: this.getHeader(),
    });
  }
  getSubProduct(data) {
    return this.http.post(this.getSubProductUrl, data, {
      headers: this.getHeader(),
    });
  }

  getProject(data) {
    return this.http.post(this.getProjectUrl, data, {
      headers: this.getHeader(),
    });
  }

  getAllColors(data) {
    return this.http.post(this.getAllColorsUrl, data, {
      headers: this.getHeader(),
    });
  }

  addColor(data) {
    return this.http.post(this.addColorUrl, data, {
      headers: this.getHeader(),
    });
  }
  ...
  getAllThickness(data) {
    return this.http.post(this.getAllThicknessUrl, data, {
      headers: this.getHeader(),
    });
  }

  addThickness(data) {
    return this.http.post(this.addThicknessUrl, data, {
      headers: this.getHeader(),
    });
  }
  getAllLength(data) {
    return this.http.post(this.getAllLengthUrl, data, {
      headers: this.getHeader(),
    });
  }

  addLength(data) {
    return this.http.post(this.addLengthUrl, data, {
      headers: this.getHeader(),
    });
  }
  getAllMaterial(data) {
    return this.http.post(this.getAllMaterialUrl, data, {
      headers: this.getHeader(),
    });
  }

  addMaterial(data) {
    return this.http.post(this.addMaterialUrl, data, {
      headers: this.getHeader(),
    });
  }

  getAllProductCategory(data) {
    return this.http.post(this.getAllProductCategoryUrl, data, {
      headers: this.getHeader(),
    });
  }

  getAllProductSize(data) {
    return this.http.post(this.getAllProductSizeUrl, data, {
      headers: this.getHeader(),
    });
  }
  addSize(data) {
  ...
  getAllCore(data) {
    return this.http.post(this.getAllCoreUrl, data, {
      headers: this.getHeader(),
    });
  }
  ...
  getAllPad(data) {
    return this.http.post(this.getAllPadUrl, data, {
      headers: this.getHeader(),
    });
  }
  ...
  getAllWearLayer(data) {
    return this.http.post(this.getAllWearLayerUrl, data, {
      headers: this.getHeader(),
    });
  }

  addWearLayer(data) {
    return this.http.post(this.addWearLayerUrl, data, {
      headers: this.getHeader(),
    });
  }
  getAllProductListForSubProduct(data) {
    return this.http.post(this.getAllProductListForSubProductUrl, data, {
      headers: this.getHeader(),
    });
  }
  addSubProduct(data) {
    return this.http.post(this.addSubProductUrl, data, {
      headers: this.getHeader(),
    });
  }
}
